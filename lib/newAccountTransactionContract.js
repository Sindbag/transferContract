...
export function getContractCode(senderName, receiverAddress) {
...
export function compileContract(contractName, contractCode) {
...
export async function deployContract(web3, abi, code, password) {
...
export function createContract(web3Config = null, password, senderName, receiverAddress) {
